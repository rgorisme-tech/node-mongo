...
const { updateProfile, changePassword } = require('../../controller/user');
// @route    POST api/users
// @desc     Register user
// @access   Public
router.get('/', async (req, res) => {
  res.json('23234234234234');
  console.log('111');
});
router.post(
  '/',
